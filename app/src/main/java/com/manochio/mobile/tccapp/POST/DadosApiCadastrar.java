...
public class DadosApiCadastrar extends AsyncTask<Void, Void, String> {
    ...
    public DadosApiCadastrar(Context ctx, String linkAPI, String first_name, String last_name, String email, String password,
    ...
    protected String doInBackground(Void... params) {
        ...
        try{
            ...
            if (responseCode == HttpURLConnection.HTTP_OK){
                ...
                result = /*"Cadastro realizado com sucesso!" */sb.toString();
