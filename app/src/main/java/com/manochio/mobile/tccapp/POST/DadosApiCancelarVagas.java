...
public class DadosApiCancelarVagas extends AsyncTask<Void, Void, String> {
    ...
    public DadosApiCancelarVagas(Context ctx, String linkAPI, String id_vaga, int id_user){
    ...
    protected String doInBackground(Void... params) {
        ...
        try{
            ...
            parametrosPost.put("id_user", id_user);
            ...
            String respondeName = urlConnection.getResponseMessage();
            ...
            if (responseCode == HttpURLConnection.HTTP_OK){
                ...
                in.close();
                result = "Vaga cancelada!";
                //result= sb.toString();
            }
            else{
                result = "Erro:" + responseCode + " " + respondeName;
            }
